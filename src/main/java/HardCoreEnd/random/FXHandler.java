...
public final class FXHandler{
    ...
    private static final FXClientProxy fx = (FXClientProxy) Main.fx;

    public static void handleBasic(World world, EntityPlayerMP player, FXType.Basic fxType, double x, double y, double z){
        switch(fxType){
