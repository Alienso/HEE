...
public class Pos{
    ...
    public static Pos at(TileEntity tile){
        return new Pos(tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ());
    }
    

    public static Pos at(Vec3d vec){
        return new Pos(MathUtil.floor(vec.x), MathUtil.floor(vec.y), MathUtil.floor(vec.z));
    }
   ...
   /* public static Pos getTopBlock(World world, int x, int z, Predicate<BlockInfo> checkFunc){
    ...
    public double distance(TileEntity tile){
        return MathUtil.distance(tile.getPos().getX()-getX(), tile.getPos().getY()-getY(), tile.getPos().getZ()-getZ());
    }
    ...
    public double distanceSquared(TileEntity tile){
        return MathUtil.distanceSquared(tile.getPos().getX()-getX(), tile.getPos().getY()-getY(), tile.getPos().getZ()-getZ());
    }

    /* === WORLD === */

    public boolean setAir(World world){
        return world.setBlockToAir(new BlockPos(getX(), getY(), getZ()));
    }
    ...
    */
    public boolean setBlock(World world, IBlockState state){
        return world.setBlockState(new BlockPos(getX(), getY(), getZ()), state, 3);
    }
    ...
    public boolean isAir(IBlockAccess world){
        return world.isAirBlock(new BlockPos(getX(), getY(), getZ()));
    }

    public Block getBlock(IBlockAccess world){
        return world.getBlockState(new BlockPos(getX(), getY(), getZ())).getBlock();
    }

    /*public int getMetadata(IBlockAccess world){
        return world.getBlockState(new BlockPos(getX(), getY(), getZ())).;
    }*/
