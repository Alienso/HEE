...
public abstract class TerritoryProperties<T extends Enum<T>>{
    ...
    private @Nullable
    IRangeGenerator variationAmountCommon;
    ...
    protected final void setCommonAmount(RandomAmount amountAlgo){
        setCommonAmount(new IRangeGenerator.RangeGenerator(0, variationsCommon.size(), amountAlgo));
    }

    protected final void setCommonAmount(RandomAmount amountAlgo, int max){
        setCommonAmount(new IRangeGenerator.RangeGenerator(0, max, amountAlgo));
    }
    ...
    protected final void setRareAmount(RandomAmount amountAlgo){
        setRareAmount(new IRangeGenerator.RangeGenerator(0, variationsRare.size(), amountAlgo));
    }

    protected final void setRareAmount(RandomAmount amountAlgo, int max){
        setRareAmount(new IRangeGenerator.RangeGenerator(0, max, amountAlgo));
    }
