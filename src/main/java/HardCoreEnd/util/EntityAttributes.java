...
public final class EntityAttributes{
    public static final IAttribute maxHealth = SharedMonsterAttributes.MAX_HEALTH;
    public static final IAttribute attackDamage = SharedMonsterAttributes.ATTACK_DAMAGE;
    public static final IAttribute movementSpeed = SharedMonsterAttributes.MOVEMENT_SPEED;
    public static final IAttribute followRange = SharedMonsterAttributes.FOLLOW_RANGE;
